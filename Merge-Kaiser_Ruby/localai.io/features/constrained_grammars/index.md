...
-   *feature_search* Features
    ...
    -   [✍️ Constrained Grammars](index.html){.sidebar-nested-link}
    -   [🆕🖧 Distributed
...
-   [✍️ Constrained Grammars]{itemprop="name"}

On this page

-   -   [Overview](index.html#overview)
    -   [Setup](index.html#setup)
    -   [💡 Usage Example](index.html#-usage-example)
        -   [Example: Binary Response
            Constraint](index.html#example-binary-response-constraint)
...
# ✍️ Constrained Grammars {#constrained-grammars .content-title .mb-0}

## Overview [*link*](index.html#overview){.anchor aria-hidden="true"} {#overview}

The `chat` endpoint supports the `grammar` parameter, which allows users
to specify a grammar in Backus-Naur Form (BNF). This feature enables the
Large Language Model (LLM) to generate outputs adhering to a
user-defined schema, such as `JSON`, `YAML`, or any other format that
can be defined using BNF. For more details about BNF, see [Backus-Naur
Form on
...
**Compatibility Notice:** This feature is only supported by models that
use the
[llama.cpp![](data:image/svg+xml;base64,)](https://github.com/ggerganov/llama.cpp){rel="external"
target="_blank"} backend. For a complete list of compatible models,
refer to the [Model
Compatibility](../../model-compatibility/index.html){bs-delay="{\"hide\":300,\"show\":550}"
bs-html="true"
bs-title="<a href='/model-compatibility/'><p>REFERENCES</p><strong>Model compatibility table</strong><br></a>"
bs-toggle="tooltip"} page. For technical details, see the related pull
requests: [PR
#1773![](data:image/svg+xml;base64,)](https://github.com/ggerganov/llama.cpp/pull/1773){rel="external"
target="_blank"} and [PR
#1887![](data:image/svg+xml;base64,)](https://github.com/ggerganov/llama.cpp/pull/1887){rel="external"
target="_blank"}.

## Setup [*link*](index.html#setup){.anchor aria-hidden="true"} {#setup}

To use this feature, follow the installation and setup instructions on
the [LocalAI
Functions](../openai-functions/index.html){bs-delay="{\"hide\":300,\"show\":550}"
bs-html="true"
bs-title="<a href='/features/openai-functions/'><p>FEATURES</p><strong>🔥 OpenAI functions and tools</strong><br></a>"
bs-toggle="tooltip"} page. Ensure that your local setup meets all the
prerequisites specified for the llama.cpp backend.

## 💡 Usage Example [*link*](index.html#-usage-example){.anchor aria-hidden="true"} {#-usage-example}

The following example demonstrates how to use the `grammar` parameter to
constrain the model's output to either "yes" or "no". This can be
particularly useful in scenarios where the response format needs to be
strictly controlled.

### Example: Binary Response Constraint [*link*](index.html#example-binary-response-constraint){.anchor aria-hidden="true"} {#example-binary-response-constraint}

``` {#3a92d14 .language-bash}
...
In this example, the `grammar` parameter is set to a simple choice
between "yes" and "no", ensuring that the model's response adheres
strictly to one of these options regardless of the context.
...
page](https://github.com/mudler/LocalAI/blob/master/docs/content/docs/features/constrained_grammars.md){alt="✍️ Constrained Grammars"
rel="noopener noreferrer" target="_blank"}

Last updated [25 May 2024, 20:18 +0200 ]{#relativetime
authdate="2024-05-25T20:18:25+0200" title="25 May 2024, 20:18 +0200"}.
...
[](../gpt-vision/index.html)

*navigate_before* 🥽 GPT Vision

[](../distribute/index.html){.ms-auto}

🆕🖧 Distributed Inference *navigate_next*
