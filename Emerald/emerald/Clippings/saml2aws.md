...
source: https://github.com/Versent/saml2aws
author:
...
CLI tool which enables you to login and retrieve [[AWS]] temporary credentials using with [ADFS](https://msdn.microsoft.com/en-us/library/bb897402.aspx) or [PingFederate](https://www.pingidentity.com/en/products/pingfederate.html) Identity Providers.

This is based on python code from [How to Implement a General Solution for Federated API/CLI Access Using SAML 2.0](https://blogs.aws.amazon.com/security/post/TxU0AVUS9J00FP/How-to-Implement-a-General-Solution-for-Federated-API-CLI-Access-Using-SAML-2-0).
...
- [Table of Contents](https://github.com/Versent/#table-of-contents)
- [Requirements](https://github.com/Versent/#requirements)
- [Caveats](https://github.com/Versent/#caveats)
- [Install](https://github.com/Versent/#install)
- [macOS](https://github.com/Versent/#macOS)
- [Windows](https://github.com/Versent/#windows)
- [Linux](https://github.com/Versent/#linux)
- [Ubuntu](https://github.com/Versent/#ubuntu)
- [Other](https://github.com/Versent/#other)
- [Using Make](https://github.com/Versent/#using-make)
- [Arch Linux and its derivatives](https://github.com/Versent/#arch-linux-and-its-derivatives)
- [Void Linux](https://github.com/Versent/#void-linux)
- [Autocomplete](https://github.com/Versent/#autocomplete)
- [Bash](https://github.com/Versent/#bash)
- [Zsh](https://github.com/Versent/#zsh)
- [Dependency Setup](https://github.com/Versent/#dependency-setup)
- [Usage](https://github.com/Versent/#usage)
- [`saml2aws script`](https://github.com/Versent/#saml2aws-script)
- [`saml2aws exec`](https://github.com/Versent/#saml2aws-exec)
- [Configuring IDP Accounts](https://github.com/Versent/#configuring-idp-accounts)
- [Example](https://github.com/Versent/#example)
- [Advanced Configuration](https://github.com/Versent/#advanced-configuration)
- [Windows Subsystem Linux (WSL) Configuration](https://github.com/Versent/#windows-subsystem-linux-wsl-configuration)
- [Option 1: Disable Keychain](https://github.com/Versent/#option-1-disable-keychain)
- [Option 2: Configure Pass to be the default keyring](https://github.com/Versent/#option-2-configure-pass-to-be-the-default-keyring)
- [Configuring Multiple Accounts](https://github.com/Versent/#configuring-multiple-accounts)
- [Dev Account Setup](https://github.com/Versent/#dev-account-setup)
- [Test Account Setup](https://github.com/Versent/#test-account-setup)
- [Advanced Configuration (Multiple AWS account access but SAML authenticate against a single 'SSO' AWS account)](https://github.com/Versent/#advanced-configuration-multiple-aws-account-access-but-saml-authenticate-against-a-single-sso-aws-account)
- [Advanced Configuration - additional parameters](https://github.com/Versent/#advanced-configuration---additional-parameters)
- [Building](https://github.com/Versent/#building)
- [macOS](https://github.com/Versent/#macos)
- [Linux](https://github.com/Versent/#linux-1)
- [Environment vars](https://github.com/Versent/#environment-vars)
- [Dependencies](https://github.com/Versent/#dependencies)
- [Releasing](https://github.com/Versent/#releasing)
- [Debugging Issues with IDPs](https://github.com/Versent/#debugging-issues-with-idps)
- [Using saml2aws as credential process](https://github.com/Versent/#using-saml2aws-as-credential-process)
- [Caching the saml2aws SAML assertion for immediate reuse](https://github.com/Versent/#caching-the-saml2aws-saml-assertion-for-immediate-reuse)
- [Okta Sessions](https://github.com/Versent/#okta-sessions)
- [License](https://github.com/Versent/#license)

## Requirements

- One of the supported Identity Providers
- ADFS (2.x or 3.x)
- [AzureAD](https://github.com/Versent/saml2aws/blob/master/doc/provider/aad/README.md)
- PingFederate + PingId
- [Okta](https://github.com/Versent/saml2aws/blob/master/pkg/provider/okta/README.md)
- KeyCloak + (TOTP)
- [Google Apps](https://github.com/Versent/saml2aws/blob/master/pkg/provider/googleapps/README.md)
- [Shibboleth](https://github.com/Versent/saml2aws/blob/master/pkg/provider/shibboleth/README.md)
- [F5APM](https://github.com/Versent/saml2aws/blob/master/pkg/provider/f5apm/README.md)
- [Akamai](https://github.com/Versent/saml2aws/blob/master/pkg/provider/akamai/README.md)
- OneLogin
- NetIQ
- Browser, this uses [playwright-go](https://github.com/Versent/saml2aws/blob/master/github.com/playwright-community/playwright-go) to run a sandbox chromium window.
- [Auth0](https://github.com/Versent/saml2aws/blob/master/pkg/provider/auth0/README.md) NOTE: Currently, MFA not supported
- [JumpCloud](https://github.com/Versent/saml2aws/blob/master/doc/provider/jumpcloud/README.md)
...
Some users of Ubuntu have reported issue with the [Others](https://github.com/Versent/#others) Install instruction and reported the following to work (may required using sudo command like for the "mv" function)
...
The `--exec-profile` flag allows for a command to execute using an aws profile which may have chained "assume role" actions. (via 'source\_profile' in ~/.aws/config)
...
There are a few steps involved with this option - however this option will save your credentials (such as your password to your IDP, and session tokens etc) into the `pass`\[[https://www.passwordstore.org/](https://www.passwordstore.org/)\] keyring. The `pass` keyring is the standard Unix password manager. This option was *heavily inspired* by a similar issue in [aws-vault](https://github.com/99designs/aws-vault/issues/683)
...
(Use AWS profiles to assume an aws role cross-account) (Note that the "source\_profile" is set to SAML which is my SSO AWS account since it is already authenticated)
...
- AWS\_SESSION\_TOKEN
- AWS\_SECURITY\_TOKEN
- EC2\_SECURITY\_TOKEN
- AWS\_PROFILE
- AWS\_DEFAULT\_PROFILE
- AWS\_CREDENTIAL\_EXPIRATION
...
You can use `saml2aws` as a credential provider by simply configuring it and then adding a profile to the AWS configuration. `saml2aws` has a flag `--credential-process` generating an output with the right JSON format, as well as a flag `--quiet` that will block the logging from being displayed. The AWS credential file (typically ~/.aws/credentials) has precedence over the credential\_process provider. That means that if credentials are present in the file, the credential process will not trigger. To counter that you can override the aws credential location of `saml2aws` to another file using `--credential-file` or specifying it during `configure`.

The AWS credential file (typically ~/.aws/credentials) has precedence over the credential\_process provider. That means that if credentials are present in the file, the credential process will not trigger.
