...
12.  [[ch06-github.xhtml|GitHub]]
    1.  [[GitHub|Account Setup and Configuration]]
        1.  [[GitHub|SSH Access]]
        2.  [[GitHub|Your Avatar]]
        3.  [[GitHub|Your Email Addresses]]
        4.  [[GitHub|Two Factor Authentication]]
    2.  [[GitHub|Contributing to a Project]]
        1.  [[GitHub|Forking Projects]]
        2.  [[GitHub|The GitHub Flow]]
        3.  [[GitHub|Advanced Pull Requests]]
        4.  [[GitHub|GitHub Flavored Markdown]]
        5.  [[GitHub|Keep your GitHub public repository up-to-date]]
    3.  [[GitHub|Maintaining a Project]]
        1.  [[GitHub|Creating a New Repository]]
        2.  [[GitHub|Adding Collaborators]]
        3.  [[GitHub|Managing Pull Requests]]
        4.  [[GitHub|Mentions and Notifications]]
        5.  [[GitHub|Special Files]]
        6.  [[GitHub|README]]
        7.  [[GitHub|CONTRIBUTING]]
        8.  [[GitHub|Project Administration]]
    4.  [[GitHub|Managing an organization]]
        1.  [[GitHub|Organization Basics]]
        2.  [[GitHub|Teams]]
        3.  [[GitHub|Audit Log]]
    5.  [[GitHub|Scripting GitHub]]
        1.  [[GitHub|Services and Hooks]]
        2.  [[GitHub|The GitHub API]]
        3.  [[GitHub|Basic Usage]]
        4.  [[GitHub|Commenting on an Issue]]
        5.  [[GitHub|Changing the Status of a Pull Request]]
        6.  [[GitHub|Octokit]]
    6.  [[GitHub|Summary]]
