...
tags:
  - docs/laravel
---
[See everything we announced at Laracon US 2025. Read the blog post →](https://blog.laravel.com/everything-we-announced-at-laracon-us-2025)

- [[#Introduction|Introduction]]
	- [[#Introduction#Publishing the Language Files|Publishing the Language Files]]
	- [[#Introduction#Configuring the Locale|Configuring the Locale]]
		- [[#Configuring the Locale#Determining the Current Locale|Determining the Current Locale]]
	- [[#Introduction#Pluralization Language|Pluralization Language]]
- [[#Defining Translation Strings|Defining Translation Strings]]
	- [[#Defining Translation Strings#Using Short Keys|Using Short Keys]]
	- [[#Defining Translation Strings#Using Translation Strings as Keys|Using Translation Strings as Keys]]
		- [[#Using Translation Strings as Keys#Key / File Conflicts|Key / File Conflicts]]
- [[#Retrieving Translation Strings|Retrieving Translation Strings]]
	- [[#Retrieving Translation Strings#Replacing Parameters in Translation Strings|Replacing Parameters in Translation Strings]]
		- [[#Replacing Parameters in Translation Strings#Object Replacement Formatting|Object Replacement Formatting]]
	- [[#Retrieving Translation Strings#Pluralization|Pluralization]]
...
If you are using your [default translation strings as your translation keys](https://laravel.com/docs/12.x/#using-translation-strings-as-keys), you should pass the default translation of your string to the `__` function;
...
If you are using the [Blade templating engine](https://laravel.com/docs/12.x/blade), you may use the `{{ }}` echo syntax to display the translation string:
...
Of course, pluralization is also supported when using [translation strings as keys](https://laravel.com/docs/12.x/#using-translation-strings-as-keys):
