...
created: 2025-05-27
published:
source: "https://github.com/Exafunction/windsurf.nvim"
tags:
---
**[windsurf.nvim](https://github.com/Exafunction/windsurf.nvim)** Public
...
<video src="https://private-user-images.githubusercontent.com/522465/215312040-d5e91a6b-cffa-48f1-909f-360328b5af79.webm?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..7o8qblPtNMQT9ei7vH54GWZVYWiXOlf7oN_gtDxOW60" controls="controls"></video>
...
- `tools`: paths to binaries used by the plugin:
	...
	- `language_server`: The path to the language server downloaded from the
...
When using virtual text, Windsurf status can be generated by calling `require('codeium.virtual_text').status_string()`. It produces a 3 char long string with Windsurf status:
...
- [Lua 94.8%](https://github.com/Exafunction/windsurf.nvim/search?l=lua)
- [Nix 4.1%](https://github.com/Exafunction/windsurf.nvim/search?l=nix)
- [PowerShell 1.1%](https://github.com/Exafunction/windsurf.nvim/search?l=powershell)