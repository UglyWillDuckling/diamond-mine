...
# Features {#features .content-title .mb-0}

[](gpu-acceleration/index.html){.text-decoration-none .text-reset}

[*article*]{.icon-color .d-flex .my-3}

⚡ GPU acceleration

[](text-generation/index.html){.text-decoration-none .text-reset}

[*article*]{.icon-color .d-flex .my-3}

📖 Text generation (GPT)

[](reranker/index.html){.text-decoration-none .text-reset}

[*article*]{.icon-color .d-flex .my-3}

📈 Reranker

[](text-to-audio/index.html){.text-decoration-none .text-reset}

[*article*]{.icon-color .d-flex .my-3}

🗣 Text to audio (TTS)

[](image-generation/index.html){.text-decoration-none .text-reset}

[*article*]{.icon-color .d-flex .my-3}

🎨 Image generation

[](embeddings/index.html){.text-decoration-none .text-reset}

[*article*]{.icon-color .d-flex .my-3}

🧠 Embeddings

[](gpt-vision/index.html){.text-decoration-none .text-reset}

[*article*]{.icon-color .d-flex .my-3}

🥽 GPT Vision

[](constrained_grammars/index.html){.text-decoration-none .text-reset}

[*article*]{.icon-color .d-flex .my-3}

✍️ Constrained Grammars

[](distribute/index.html){.text-decoration-none .text-reset}

[*article*]{.icon-color .d-flex .my-3}

🆕🖧 Distributed Inference

[](audio-to-text/index.html){.text-decoration-none .text-reset}

[*article*]{.icon-color .d-flex .my-3}

🔈 Audio to text

[](openai-functions/index.html){.text-decoration-none .text-reset}

[*article*]{.icon-color .d-flex .my-3}

🔥 OpenAI functions and tools

[](../stores/index.html){.text-decoration-none .text-reset}

[*article*]{.icon-color .d-flex .my-3}

💾 Stores

[](../models/index.html){.text-decoration-none .text-reset}
