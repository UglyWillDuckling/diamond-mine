...
## NAME         [top](https://man7.org/linux/man-pages/man8/#top_of_page)

```
       ss - another utility to investigate sockets
```

## SYNOPSIS         [top](https://man7.org/linux/man-pages/man8/#top_of_page)

```
       ss [options] [ FILTER ]
```

## DESCRIPTION         [top](https://man7.org/linux/man-pages/man8/#top_of_page)
...
## OPTIONS         [top](https://man7.org/linux/man-pages/man8/#top_of_page)
...
## STATE-FILTER         [top](https://man7.org/linux/man-pages/man8/#top_of_page)
...
## EXPRESSION         [top](https://man7.org/linux/man-pages/man8/#top_of_page)
...
## HOST SYNTAX         [top](https://man7.org/linux/man-pages/man8/#top_of_page)
...
## USAGE EXAMPLES         [top](https://man7.org/linux/man-pages/man8/#top_of_page)
...
## SEE ALSO         [top](https://man7.org/linux/man-pages/man8/#top_of_page)
...
## AUTHOR         [top](https://man7.org/linux/man-pages/man8/#top_of_page)
...
## COLOPHON         [top](https://man7.org/linux/man-pages/man8/#top_of_page)
...
Pages that refer to this page: [lsfd(1)](https://man7.org/linux/man-pages/man1/lsfd.1.html),  [pcp-ss(1)](https://man7.org/linux/man-pages/man1/pcp-ss.1.html),  [pmdasockets(1)](https://man7.org/linux/man-pages/man1/pmdasockets.1.html),  [netstat(8)](https://man7.org/linux/man-pages/man8/netstat.8.html),  [ping(8)](https://man7.org/linux/man-pages/man8/ping.8.html)
