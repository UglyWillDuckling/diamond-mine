...
-   *rocket_launch* Getting started
    ...
    -   [Run with Kubernetes](index.html){.sidebar-nested-link}
...
-   [Run with Kubernetes]{itemprop="name"}
...
# Run with Kubernetes {#run-with-kubernetes .content-title .mb-0}

For installing LocalAI in Kubernetes, the deployment file from the
`examples` can be used and customized as prefered:
...
target="_blank"} can be used as well:

``` {#d23d9dc .language-bash}
...
page](https://github.com/mudler/LocalAI/blob/master/docs/content/docs/getting-started/kubernetes.md){alt="Run with Kubernetes"
rel="noopener noreferrer" target="_blank"}

Last updated [05 Dec 2024, 16:06 +0100 ]{#relativetime
authdate="2024-12-05T16:06:51+0100" title="05 Dec 2024, 16:06 +0100"}.
...
*navigate_before* Run with container images

[](../news/index.html){.ms-auto}
