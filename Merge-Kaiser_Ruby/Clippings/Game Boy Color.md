...
<table><caption>Game Boy Color</caption><tbody><tr><td colspan="2"><span><a href="https://en.wikipedia.org/wiki/File:Game_Boy_Color_logo.svg"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Game_Boy_Color_logo.svg/150px-Game_Boy_Color_logo.svg.png" width="150" height="61"></a></span></td></tr><tr><td colspan="2"><span><a href="https://en.wikipedia.org/wiki/File:Nintendo_Game_Boy_Color.png"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/26/Nintendo_Game_Boy_Color.png/220px-Nintendo_Game_Boy_Color.png" width="220" height="304"></a></span><p>Game Boy Color with <a href="https://en.wikipedia.org/wiki/#Model_colors">Atomic Purple</a> case</p></td></tr><tr><th scope="row"><span>Also known as</span></th><td>CGB-001</td></tr><tr><th scope="row">Developer</th><td><a href="https://en.wikipedia.org/wiki/Nintendo_Research_%26_Engineering">Nintendo Research &amp; Engineering</a></td></tr><tr><th scope="row">Manufacturer</th><td><a href="https://en.wikipedia.org/wiki/Nintendo">Nintendo</a></td></tr><tr><th scope="row">Product family</th><td><a href="https://en.wikipedia.org/wiki/Game_Boy_family">Game Boy</a></td></tr><tr><th scope="row">Type</th><td><a href="https://en.wikipedia.org/wiki/Handheld_game_console">Handheld game console</a></td></tr><tr><th scope="row">Generation</th><td><a href="https://en.wikipedia.org/wiki/Fifth_generation_of_video_game_consoles">Fifth</a></td></tr><tr><th scope="row">Release date</th><td><div><ul><li><span><a href="https://en.wikipedia.org/wiki/Japan">JP</a>:</span> October 21, 1998</li><li><span><a href="https://en.wikipedia.org/wiki/North_America">NA</a>:</span> November 18, 1998</li><li><span><a href="https://en.wikipedia.org/wiki/Europe">EU</a>:</span> November 23, 1998</li><li><span><a href="https://en.wikipedia.org/wiki/Australasia">AU</a>:</span> November 27, 1998</li></ul></div></td></tr><tr><th scope="row">Introductory price</th><td><span>US$79.95</span> (equivalent to $150 in 2023)</td></tr><tr><th scope="row">Discontinued</th><td>March 31, 2003</td></tr><tr><th scope="row">Units sold</th><td>118.69 million (including all Game Boy variants)</td></tr><tr><th scope="row">Media</th><td><a href="https://en.wikipedia.org/wiki/Game_Boy_Game_Pak">Game Boy Game Pak</a><br><a href="https://en.wikipedia.org/wiki/Game_Boy_Color_Game_Pak">Game Boy Color Game Pak</a></td></tr><tr><th scope="row"><a href="https://en.wikipedia.org/wiki/System_on_a_chip">System on a chip</a></th><td>Nintendo CPU&nbsp;CGB</td></tr><tr><th scope="row"><a href="https://en.wikipedia.org/wiki/Central_processing_unit">CPU</a></th><td>Sharp&nbsp;SM83 @ 4.2&nbsp;/&nbsp;8.4&nbsp;MHz</td></tr><tr><th scope="row">Memory</th><td>32&nbsp;KB&nbsp;<a href="https://en.wikipedia.org/wiki/Random-access_memory">RAM</a>, 16&nbsp;KB&nbsp;<a href="https://en.wikipedia.org/wiki/Video_RAM_(dual-ported_DRAM)">Video&nbsp;RAM</a></td></tr><tr><th scope="row">Display</th><td>Reflective <a href="https://en.wikipedia.org/wiki/TFT_LCD">TFT LCD</a> 160&nbsp;×&nbsp;144&nbsp;<a href="https://en.wikipedia.org/wiki/Pixels">px</a>, 44&nbsp;×&nbsp;40&nbsp;mm (1.7&nbsp;×&nbsp;1.6&nbsp;in)</td></tr><tr><th scope="row">Online services</th><td><div><ul><li><span><a href="https://en.wikipedia.org/wiki/Japan">JP</a>:</span> <a href="https://en.wikipedia.org/wiki/Mobile_System_GB">Mobile System GB</a></li></ul></div></td></tr><tr><th scope="row"><a href="https://en.wikipedia.org/wiki/List_of_best-selling_video_games">Best-selling game</a></th><td><a href="https://en.wikipedia.org/wiki/Pok%C3%A9mon_Gold_and_Silver"><i>Pokémon Gold</i> and <i>Silver</i></a> (23&nbsp;million)</td></tr><tr><th scope="row"><a href="https://en.wikipedia.org/wiki/Backward_compatibility">Backward<br>compatibility</a></th><td><a href="https://en.wikipedia.org/wiki/Game_Boy">Game Boy</a></td></tr><tr><th scope="row">Predecessor</th><td>Game Boy</td></tr><tr><th scope="row">Successor</th><td><a href="https://en.wikipedia.org/wiki/Game_Boy_Advance">Game Boy Advance</a></td></tr></tbody></table>

The **Game Boy Color** (**GBC** or **CGB**) is an 8-bit [handheld game console](https://en.wikipedia.org/wiki/Handheld_game_console "Handheld game console"), manufactured by [Nintendo](https://en.wikipedia.org/wiki/Nintendo "Nintendo"), which was released in Japan on October 21, 1998, and to international markets that November. Compared to the original [Game Boy](https://en.wikipedia.org/wiki/Game_Boy "Game Boy"), the Game Boy Color features a color [TFT screen](https://en.wikipedia.org/wiki/TFT_screen "TFT screen") rather than [monochrome](https://en.wikipedia.org/wiki/Monochrome_monitor "Monochrome monitor"), a processor that can operate twice as fast, and four times as much memory. It retains [backward compatibility](https://en.wikipedia.org/wiki/Backward_compatibility "Backward compatibility") with games initially developed for its predecessor.

While the handheld was slightly thicker, taller and had a smaller screen than its immediate predecessor, the [Game Boy Pocket](https://en.wikipedia.org/wiki/Game_Boy_Pocket "Game Boy Pocket"), the Color was significantly smaller than the original Game Boy. As with its predecessors, the Game Boy Color has a custom [8-bit](https://en.wikipedia.org/wiki/8-bit "8-bit") processor made by [Sharp](https://en.wikipedia.org/wiki/Sharp_Corporation "Sharp Corporation"). The [American English spelling](https://en.wikipedia.org/wiki/American_and_British_English_spelling_differences#-our,_-or "American and British English spelling differences") of the system's name, *Game Boy Color*, remains consistent throughout the world.

While it received positive reviews upon its release, the Game Boy Color was seen as more of a transitional upgrade of the original Game Boy rather than a completely new device. It would have a relatively brief lifespan, being supplanted by the [Game Boy Advance](https://en.wikipedia.org/wiki/Game_Boy_Advance "Game Boy Advance") after less than three years on the market.
...
The SoC contains a 2 KB "bootstrap" ROM which is used to start up the device,[^20] 127 B of High RAM that can be accessed faster (similar to a [CPU cache](https://en.wikipedia.org/wiki/CPU_cache "CPU cache")), and the *Audio Processing Unit*, a [programmable sound generator](https://en.wikipedia.org/wiki/Programmable_sound_generator "Programmable sound generator") with four channels: a [pulse wave](https://en.wikipedia.org/wiki/Pulse_wave "Pulse wave") generation channel with frequency and volume variation, a second pulse wave generation channel with only volume variation, a wave channel than can reproduce any [waveform](https://en.wikipedia.org/wiki/Waveform "Waveform") recorded in RAM, and a [white noise](https://en.wikipedia.org/wiki/White_noise "White noise") channel with volume variation.[^game_boy_programming_manual-15] [^gba_service_manual-21] The motherboard of the Game Boy Color contains a 32 KB "work" [RAM](https://en.wikipedia.org/wiki/Random-access_memory "Random-access memory") chip, four times more than the original Game Boy.[^game_boy_programming_manual-15] 

The Game Boy features a [D-pad](https://en.wikipedia.org/wiki/D-pad "D-pad") (directional pad), four action buttons labeled 'A,' 'B,' 'SELECT,' and 'START,' and a sliding on-off switch on the right side of the device. The volume is adjusted by a [potentiometer](https://en.wikipedia.org/wiki/Potentiometer "Potentiometer") dial on the left side of the device.

The left side offers a [Game Link Cable](https://en.wikipedia.org/wiki/Game_Link_Cable "Game Link Cable") port for connecting to up to four Game Boy devices for multiplayer games or, notably in *Pokémon* series games, trading and battling.[^22] This port can be used with a [Game Boy Printer](https://en.wikipedia.org/wiki/Game_Boy_Printer "Game Boy Printer"). The port used on the Game Boy Color is of a smaller design first introduced on the Game Boy Pocket, and requires an adapter to link with the original Game Boy.[^23] The Game Boy Color also offered a "high-speed" mode that could operate up 64 times faster than the original Game Boy.[^game_boy_programming_manual-15]  The Game Boy Color added an infrared communications port for wireless data transfer, which was supported by a small number of games; the infrared port was not included on the later [Game Boy Advance](https://en.wikipedia.org/wiki/Game_Boy_Advance "Game Boy Advance") line.[^gba_service_manual-21]

### Technical specifications

|  | Game Boy Color[^24][^25][^game_boy_programming_manual-15] |
| --- | --- |
| Height | 133.5 mm (5.26 in) |
| Width | 78 mm (3.1 in) |
| Depth | 27.4 mm (1.08 in) |
| Weight | 138 g (4.9 oz) |
| Display | 2.3-inch (diagonal) reflective [thin-film transistor](https://en.wikipedia.org/wiki/Thin-film_transistor "Thin-film transistor") (TFT) color [liquid-crystal display](https://en.wikipedia.org/wiki/Liquid-crystal_display "Liquid-crystal display") (LCD) |
| Screen size (playable) | 43 mm × 39 mm (1.7 in × 1.5 in)[^26] |
| [Resolution](https://en.wikipedia.org/wiki/Display_resolution "Display resolution") | 160 (w) × 144 (h) [pixels](https://en.wikipedia.org/wiki/Pixel "Pixel") (10:9 [aspect ratio](https://en.wikipedia.org/wiki/Aspect_ratio_\(image\) "Aspect ratio (image)"))[^27] |
| Graphics | - Maximum [sprites](https://en.wikipedia.org/wiki/Sprite_\(computer_graphics\) "Sprite (computer graphics)"): 40 total, 10 per line, 4 colors each (one transparent) - Sprite size: 8 × 8 or 8 × 16 - Tiles drawn: 512 (360~399 visible, others off-screen as a scrolling buffer) |
| [Frame rate](https://en.wikipedia.org/wiki/Frame_rate "Frame rate") | 59.727500569606 [Hz](https://en.wikipedia.org/wiki/Hertz "Hertz")[^28] |
| Color support | 32,768 colors, up to 56 simultaneously |
| [System on a chip](https://en.wikipedia.org/wiki/System_on_a_chip "System on a chip") (SoC) | Nintendo CPU CGB |
| Processor | 4.194304 / 8.388608 MHz[^29] Sharp SM83 (custom [Intel 8080](https://en.wikipedia.org/wiki/Intel_8080 "Intel 8080")/[Zilog Z80](https://en.wikipedia.org/wiki/Zilog_Z80 "Zilog Z80") hybrid, [8-bit](https://en.wikipedia.org/wiki/8-bit_computing "8-bit computing")) |
| Memory | - **On SoC:** 2 KB ROM, 127 B High RAM, 16 KB [Video RAM](https://en.wikipedia.org/wiki/Video_Random_Access_Memory "Video Random Access Memory") - **Internal:** 32 KB [RAM](https://en.wikipedia.org/wiki/Random-access_memory "Random-access memory") - **External:** (in the game cartridge) up to 8 MB ROM, up to 128 KB RAM |
| Power | - **Consumption:** 70–80 [mAh](https://en.wikipedia.org/wiki/MAh "MAh") - **Internal:** 2 × [AA batteries](https://en.wikipedia.org/wiki/AA_batteries "AA batteries")[^30] - **External:** 0.6 W at 3 V DC from 2.35 mm × 0.75 mm [coaxial connector](https://en.wikipedia.org/wiki/Coaxial_power_connector "Coaxial power connector") |
| Battery life | Up to 10 hours |
| Sound | - **Channels:** 2 pulse wave, 1 wave, 1 noise - **Outputs:** Built-in [mono](https://en.wikipedia.org/wiki/Monaural "Monaural") speaker, stereo [3.5mm headphone jack](https://en.wikipedia.org/wiki/3.5mm_headphone_jack "3.5mm headphone jack") |
...
Nintendo had seen success selling colored variations of the Play It Loud! Game Boy and the Game Boy Pocket, so the company released the Color in several case variations.[^day_2016-3]
...
Due to its backward compatibility with Game Boy games, the Game Boy Color launched with a large playable library. The system amassed a library of 576 Game Boy Color games over a four-year period. While the majority of the games are Game Boy Color exclusive, approximately 30% of the games released are compatible with the original Game Boy. Most Game Boy Color games released after 1999 are not compatible with the original Game Boy.[^35][^36][^37]

*[Tetris](https://en.wikipedia.org/wiki/Tetris_\(Game_Boy\) "Tetris (Game Boy)")* for the original Game Boy is the best-selling game compatible with Game Boy Color,[^38][^39] and [*Pokémon Gold* and *Silver*](https://en.wikipedia.org/wiki/Pok%C3%A9mon_Gold_and_Silver "Pokémon Gold and Silver") are the best-selling games developed primarily for it. The best-selling Game Boy Color exclusive game is *[Pokémon Crystal](https://en.wikipedia.org/wiki/Pok%C3%A9mon_Crystal "Pokémon Crystal")*.[^40][^41]

The last Game Boy Color game ever released is the Japanese exclusive *[Doraemon no Study Boy: Kanji Yomikaki Master](https://en.wikipedia.org/wiki/List_of_Doraemon_video_games "List of Doraemon video games")*, on July 18, 2003. The last game released in North America is *[Harry Potter and the Chamber of Secrets](https://en.wikipedia.org/wiki/Harry_Potter_and_the_Chamber_of_Secrets_\(video_game\) "Harry Potter and the Chamber of Secrets (video game)")*, released on November 15, 2002.[^42] In Europe, the last game released for the system is *[Hamtaro: Ham-Hams Unite!](https://en.wikipedia.org/wiki/Hamtaro:_Ham-Hams_Unite! "Hamtaro: Ham-Hams Unite!")*, on January 10, 2003.[^day_2016-3]

Beyond officially released games for the platform, there is an active online community creating new games for the Game Boy and Game Boy Color through the use of tools like GB Studio.[^43] One such example is Dragonhym (originally Dragonborne) which was available for release on a physical cartridge which will be playable on the Game Boy Color.[^44]

The [Game Boy](https://en.wikipedia.org/wiki/Game_Boy "Game Boy") and Game Boy Color were both commercially successful, selling 118.69 million units worldwide: 32.47 million in Japan, 44.06 million in the Americas, and 42.16 million in all other regions.[^nintendo_2016-11][^45] At the time of its discontinuation in 2003, the combined sales of all Game Boy variants made it the [best-selling game console of all time](https://en.wikipedia.org/wiki/List_of_best-selling_game_consoles "List of best-selling game consoles"). In later years, its sales were surpassed by the [Nintendo DS](https://en.wikipedia.org/wiki/Nintendo_DS "Nintendo DS"), [PlayStation 2](https://en.wikipedia.org/wiki/PlayStation_2 "PlayStation 2") and [Nintendo Switch](https://en.wikipedia.org/wiki/Nintendo_Switch "Nintendo Switch"), making it the fourth-best-selling console the second-best-selling handheld of all time, as of 2024<sup class="plainlinks noexcerpt noprint asof-tag update"><a class="external text" href="https://en.wikipedia.org/w/index.php?title=Game_Boy_Color&amp;action=edit">[update]</a></sup>. Sales of the device were in part driven by the success of *[Pokémon Gold and Silver](https://en.wikipedia.org/wiki/Pok%C3%A9mon_Gold_and_Silver "Pokémon Gold and Silver")* and *[Pokémon Crystal](https://en.wikipedia.org/wiki/Pok%C3%A9mon_Crystal "Pokémon Crystal")*, with combined sales of 29.5 million units, making them one of the [best selling-video games of all time](https://en.wikipedia.org/wiki/List_of_best-selling_video_games "List of best-selling video games").[^46][^47]

Sales of the Game Boy Color were strong at launch. [Nintendo](https://en.wikipedia.org/wiki/Nintendo "Nintendo") of America reported a sale of one million units from launch to December 1998,[^gaming_intelligence_1999-48] and two million by July 1999.[^49] Retail chains in the [United States](https://en.wikipedia.org/wiki/United_States "United States") reported unexpectedly high demand for the console, with executives of [FuncoLand](https://en.wikipedia.org/wiki/FuncoLand "FuncoLand") reporting "very pleasant and unpredicted" sales and [Electronics Boutique](https://en.wikipedia.org/wiki/Electronics_Boutique "Electronics Boutique") stating "the entire Game Boy Color line just exploded, including accessories" upon release.[^50] Faced with high worldwide demand and competitive retail pricing, retailers such as [CompUSA](https://en.wikipedia.org/wiki/CompUSA "CompUSA") sold out of Game Boy Color stock in the weeks before the 1998 Christmas season.[^gaming_intelligence_1999-48]
...
- [List of Game Boy accessories](https://en.wikipedia.org/wiki/List_of_Game_Boy_accessories "List of Game Boy accessories")
