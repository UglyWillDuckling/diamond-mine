...
[[Laravel logging Show correct severity levels on GCP]]

- [x] logging on GCP will need to be implemented
- [ ] we will need some type of tracking to cover everything that was and needs to be implemented
- [ ] ..