...
- [/] setup [[#real ssl cert]]
- [ ] #task [[write down how to setup local ssl certificate]]
...
- [ ] #task see how to implement a [[cronjob]] for the certificate <mark style="background: #FFF3A3A6;">renewal</mark> 🔼
- [/] #task write web server setup documentation #docs
