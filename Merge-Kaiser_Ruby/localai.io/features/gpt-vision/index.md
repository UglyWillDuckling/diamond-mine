...
-   *feature_search* Features
    ...
    -   [🥽 GPT Vision](index.html){.sidebar-nested-link}
    -   [✍️ Constrained
...
Grammars and function tools can be used as well in conjunction with
vision APIs:

``` {#d0e81ff .language-bash}
   curl http://localhost:8080/v1/chat/completions -H "Content-Type: application/json" -d '{
...
All-in-One images have already shipped the llava model as
`gpt-4-vision-preview`, so no setup is needed in this case.

To setup the LLaVa models, follow the full example in the [configuration
examples![](data:image/svg+xml;base64,)](https://github.com/mudler/LocalAI/blob/master/examples/configurations/README.md#llava){rel="external"
target="_blank"}.
...
page](https://github.com/mudler/LocalAI/blob/master/docs/content/docs/features/gpt-vision.md){alt="🥽 GPT Vision"
rel="noopener noreferrer" target="_blank"}

Last updated [03 Jun 2024, 16:58 +0200 ]{#relativetime
authdate="2024-06-03T16:58:53+0200" title="03 Jun 2024, 16:58 +0200"}.
...
*navigate_before* 🧠 Embeddings

[](../constrained_grammars/index.html){.ms-auto}

✍️ Constrained Grammars *navigate_next*
