...
See [available server capabilities](https://github.com/yioneko/vtsls/blob/main/packages/server/src/capabilities.ts). Here are also [references from VSCode](https://code.visualstudio.com/docs/typescript/typescript-editing).
...
See the configuration schema [here](https://github.com/yioneko/vtsls/blob/main/packages/service/configuration.schema.json).
